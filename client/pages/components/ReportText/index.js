...
export default function ReportText({ locale, result }) {
        ...
        <main className={styles.main}>
            ...
            <p className={styles.description}>
                <i>
                    {
                        locale === "hi-HI" ? <>
                            यह रिपोर्ट पाठ के विश्लेषण को प्रदर्शित करेगी।
                            <br />इस विश्लेषण से आप समझ सकते हैं कि इनपुट की भावना सकारात्मक है या नकारात्मक।
                            </> :
                            <>This report will showcase the analysis of the text. <br /> With this analysis, you can understand
                ...
                <i>
                    {
                        locale === "hi-HI" ? <>
                            यह रिपोर्ट पाठ के विश्लेषण को प्रदर्शित करेगी।
                            <br />इस विश्लेषण के साथ, आप विशेष पाठ की संस्थाओं को समझ सकते हैं।
                            </> :
                            <>This report will showcase the analysis of the text. <br /> With this analysis,
                            you can understand the entities of the particular text.</>
                    }
                </i>
            </p>
