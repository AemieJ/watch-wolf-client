...
export default function ReportTweet({ locale, result }) {
    ...
    return (
        <main className={styles.main}>
            <h1 className={styles.title}>
                {
                    locale === "hi-HI" ? "ट्वीट विवरण" : "Tweet Details"
                }
            </h1>
            <p className={styles.description}>
                <i>
                    {
                        locale === "hi-HI" ? <>
                            यह रिपोर्ट ट्वीट के बारे में एक संक्षिप्त जानकारी प्रदान करेगी।
                            <br />इसके आधार पर, भावना और संस्थाओं की रिपोर्ट दी गई है।
                            </> :
                            <>This report will provide a brief about the tweet. <br /> Based on this, the sentiment and entities report is given.</>
                    }
                </i>
            </p>

            <div className={styles.tweet_details}>
                <Card className={styles.tweet_card}>
                    <Card.Img variant="top" src="/twitter.png" className={styles.tweet_img}/>
                    <Card.Body>
                        <Card.Title>{jsonRes.tweet.userScreenName}</Card.Title>
                        <Card.Text>
                            <b>{locale === "hi-HI" ? "उपयोगकर्ता नाम" : "Username"}: </b> @{jsonRes.tweet.username} <br/>
                            <b>{locale === "hi-HI" ? "मूलपाठ" : "Text"}: </b> {jsonRes.tweet.text} <br/>
                            <b>{locale === "hi-HI" ? "पहचान" : "ID"}: </b> {jsonRes.tweet.id}
                        </Card.Text>
                    </Card.Body>
                </Card>
            </div>
                ...
                <i>
                    {
                        locale === "hi-HI" ? <>
                            ...
                            <>This report will showcase the analysis of the tweet. <br /> With this analysis, you can understand
